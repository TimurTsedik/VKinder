...
class Favorite(Base):
    ...
    user_id = sa.Column(sa.Integer, sa.ForeignKey("users.vk_id"), nullable=False)
    user_fav_id = sa.Column(sa.Integer, sa.ForeignKey("users.vk_id"), nullable=False)
...
class BlackList(Base):
    ...
    id = sa.Column(sa.Integer, primary_key=True)
    user_id = sa.Column(sa.Integer, sa.ForeignKey("users.vk_id"), nullable=False)
    user_black_id = sa.Column(sa.Integer, sa.ForeignKey("users.vk_id"), nullable=False)
